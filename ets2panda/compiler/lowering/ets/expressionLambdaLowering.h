...
#ifndef ES2PANDA_COMPILER_LOWERING_EXPRESSION_LAMDBA_LOWERING_H
#define ES2PANDA_COMPILER_LOWERING_EXPRESSION_LAMDBA_LOWERING_H
...
class ExpressionLambdaConstructionPhase : public PhaseForSourcePrograms {
public:
