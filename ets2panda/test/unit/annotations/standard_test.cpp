...
pandasm::Program::LiteralArrayTableT const EXPECTED_LITERAL_ARRAY = {
    ...
    {"MyClass%%annotation-ClassAuthor-color-16",
     LA({{0x0_LT, 2_U8}, {0x2_LT, 0_U32}, {0x0_LT, 2_U8}, {0x2_LT, 1_U32}})},
    {"MyClass%%annotation-ClassAuthor-mutiArray-20",
     LA({{0x0_LT, 4_U8}, {0x4_LT, 1.000000}, {0x0_LT, 4_U8}, {0x4_LT, 2.000000}, {0x0_LT, 4_U8}, {0x4_LT, 3.000000}})},
    {"MyClass%%annotation-ClassAuthor-mutiArray-21",
     LA({{0x0_LT, 4_U8}, {0x4_LT, 4.000000}, {0x0_LT, 4_U8}, {0x4_LT, 5.000000}, {0x0_LT, 4_U8}, {0x4_LT, 6.000000}})},
    {"MyClass%%annotation-ClassAuthor-mutiArray-22",
     LA({{0x0_LT, 4_U8}, {0x4_LT, 7.000000}, {0x0_LT, 4_U8}, {0x4_LT, 8.000000}, {0x0_LT, 4_U8}, {0x4_LT, 9.000000}})},
    {"MyClass%%annotation-ClassAuthor-mutiArray-23", LA({{0x0_LT, 25_U8},
                                                         {0x19_LT, "MyClass%%annotation-ClassAuthor-mutiArray-20"},
                                                         {0x0_LT, 25_U8},
                                                         {0x19_LT, "MyClass%%annotation-ClassAuthor-mutiArray-21"},
                                                         {0x0_LT, 25_U8},
                                                         {0x19_LT, "MyClass%%annotation-ClassAuthor-mutiArray-22"}})},
    {"MyClass%%annotation-ClassAuthor-reviewers-17",
     LA({{0x0_LT, 5_U8}, {0x5_LT, "Bob"}, {0x0_LT, 5_U8}, {0x5_LT, "Jim"}, {0x0_LT, 5_U8}, {0x5_LT, "Tom"}})},
    {"MyClass%%annotation-ClassAuthor-reviewersAge-18", LA({{0x0_LT, 4_U8},
                                                            {0x4_LT, 18.000000},
                                                            {0x0_LT, 4_U8},
                                                            {0x4_LT, 21.000000},
                                                            {0x0_LT, 4_U8},
                                                            {0x4_LT, 32.000000}})},
    {"MyClass%%annotation-ClassAuthor-testBools-19",
     LA({{0x0_LT, 1_U8}, {0x1_LT, false}, {0x0_LT, 1_U8}, {0x1_LT, true}, {0x0_LT, 1_U8}, {0x1_LT, false}})},
    {"MyClass.foo:void;%%annotation-ClassAuthor-color-0",
     LA({{0x0_LT, 2_U8}, {0x2_LT, 0_U32}, {0x0_LT, 2_U8}, {0x2_LT, 1_U32}})},
    {"MyClass.foo:void;%%annotation-ClassAuthor-mutiArray-4",
     LA({{0x0_LT, 4_U8}, {0x4_LT, 1.000000}, {0x0_LT, 4_U8}, {0x4_LT, 2.000000}, {0x0_LT, 4_U8}, {0x4_LT, 3.000000}})},
    {"MyClass.foo:void;%%annotation-ClassAuthor-mutiArray-5",
     LA({{0x0_LT, 4_U8}, {0x4_LT, 4.000000}, {0x0_LT, 4_U8}, {0x4_LT, 5.000000}, {0x0_LT, 4_U8}, {0x4_LT, 6.000000}})},
    {"MyClass.foo:void;%%annotation-ClassAuthor-mutiArray-6",
     LA({{0x0_LT, 4_U8}, {0x4_LT, 7.000000}, {0x0_LT, 4_U8}, {0x4_LT, 8.000000}, {0x0_LT, 4_U8}, {0x4_LT, 9.000000}})},
    {"MyClass.foo:void;%%annotation-ClassAuthor-mutiArray-7",
     LA({{0x0_LT, 25_U8},
         {0x19_LT, "MyClass.foo:void;%%annotation-ClassAuthor-mutiArray-4"},
         {0x0_LT, 25_U8},
         {0x19_LT, "MyClass.foo:void;%%annotation-ClassAuthor-mutiArray-5"},
         {0x0_LT, 25_U8},
         {0x19_LT, "MyClass.foo:void;%%annotation-ClassAuthor-mutiArray-6"}})},
    {"MyClass.foo:void;%%annotation-ClassAuthor-reviewers-1",
     LA({{0x0_LT, 5_U8}, {0x5_LT, "Bob"}, {0x0_LT, 5_U8}, {0x5_LT, "Jim"}, {0x0_LT, 5_U8}, {0x5_LT, "Tom"}})},
    {"MyClass.foo:void;%%annotation-ClassAuthor-reviewersAge-2", LA({{0x0_LT, 4_U8},
                                                                     {0x4_LT, 18.000000},
                                                                     {0x0_LT, 4_U8},
                                                                     {0x4_LT, 21.000000},
                                                                     {0x0_LT, 4_U8},
                                                                     {0x4_LT, 32.000000}})},
    {"MyClass.foo:void;%%annotation-ClassAuthor-testBools-3",
     LA({{0x0_LT, 1_U8}, {0x1_LT, false}, {0x0_LT, 1_U8}, {0x1_LT, true}, {0x0_LT, 1_U8}, {0x1_LT, false}})},
};
...
public:
            ...
            {"ClassAuthor",
             {
                 ...
                 {"testBool", "0"},
                 {"favorColor", "1"},
                 {"color", "MyClass%%annotation-ClassAuthor-color-16"},
                 {"reviewers", "MyClass%%annotation-ClassAuthor-reviewers-17"},
                 {"reviewersAge", "MyClass%%annotation-ClassAuthor-reviewersAge-18"},
                 {"testBools", "MyClass%%annotation-ClassAuthor-testBools-19"},
                 {"mutiArray", "MyClass%%annotation-ClassAuthor-mutiArray-23"},
             }},
        };
    ...
    void CheckFunctionAnnotations(pandasm::Program *program)
    {
        ...
        const AnnotationMap expectedFuncAnnotations = {
            {"ClassAuthor",
             {
                 {"mutiArray", "MyClass.foo:void;%%annotation-ClassAuthor-mutiArray-7"},
                 {"color", "MyClass.foo:void;%%annotation-ClassAuthor-color-0"},
                 {"testBools", "MyClass.foo:void;%%annotation-ClassAuthor-testBools-3"},
                 {"reviewers", "MyClass.foo:void;%%annotation-ClassAuthor-reviewers-1"},
                 {"favorColor", "1"},
                 {"testBool", "0"},
                 {"reviewersAge", "MyClass.foo:void;%%annotation-ClassAuthor-reviewersAge-2"},
                 {"authorAge", "35.000000"},
                 {"authorName", "Jim"},
             }},
        };
