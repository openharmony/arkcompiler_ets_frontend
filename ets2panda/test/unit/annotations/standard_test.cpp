...
public:
            ...
            {"ClassAuthor",
             {
                 ...
                 {"testBool", "0"},
                 {"favorColor", "1"},
                 {"color", "MyClass$ClassAuthor$color$8"},
                 {"reviewers", "MyClass$ClassAuthor$reviewers$9"},
                 {"reviewersAge", "MyClass$ClassAuthor$reviewersAge$10"},
                 {"testBools", "MyClass$ClassAuthor$testBools$11"},
                 {"mutiArray", "MyClass$ClassAuthor$mutiArray$15"},
             }},
        };
    ...
    void CheckFunctionAnnotations(pandasm::Program *program)
    {
        ...
        const AnnotationMap expectedFuncAnnotations = {
            {"ClassAuthor",
             {
                 {"mutiArray", "MyClass.foo:void;$ClassAuthor$mutiArray$23"},
                 {"color", "MyClass.foo:void;$ClassAuthor$color$16"},
                 {"testBools", "MyClass.foo:void;$ClassAuthor$testBools$19"},
                 {"reviewers", "MyClass.foo:void;$ClassAuthor$reviewers$17"},
                 {"favorColor", "1"},
                 {"testBool", "0"},
                 {"reviewersAge", "MyClass.foo:void;$ClassAuthor$reviewersAge$18"},
                 {"authorAge", "35.000000"},
                 {"authorName", "Jim"},
             }},
        };
    ...
    void CheckLiteralArrayTable(pandasm::Program *program)
    {
        std::vector<std::pair<std::string, std::vector<AnnotationValueType>>> expectedLiteralArrayTable = {
            ...
            {"MyClass$ClassAuthor$color$8", std::vector<AnnotationValueType> {COLOR_OPTION_0, COLOR_OPTION_1}},
            {"MyClass$ClassAuthor$reviewers$9",
             std::vector<AnnotationValueType> {std::string("Bob"), std::string("Jim"), std::string("Tom")}},
            {"MyClass$ClassAuthor$reviewersAge$10", std::vector<AnnotationValueType> {AGE_18, AGE_21, AGE_32}},
            {"MyClass$ClassAuthor$testBools$11", std::vector<AnnotationValueType> {false, true, false}},
            {"MyClass$ClassAuthor$mutiArray$12", std::vector<AnnotationValueType> {VALUE_1, VALUE_2, VALUE_3}},
            {"MyClass$ClassAuthor$mutiArray$13", std::vector<AnnotationValueType> {VALUE_4, VALUE_5, VALUE_6}},
            {"MyClass$ClassAuthor$mutiArray$14", std::vector<AnnotationValueType> {VALUE_7, VALUE_8, VALUE_9}},
            {"MyClass$ClassAuthor$mutiArray$15",
             std::vector<AnnotationValueType> {std::string("MyClass$ClassAuthor$mutiArray$12"),
                                               std::string("MyClass$ClassAuthor$mutiArray$13"),
                                               std::string("MyClass$ClassAuthor$mutiArray$14")}},
            {"MyClass.foo:void;$ClassAuthor$color$16",
             std::vector<AnnotationValueType> {COLOR_OPTION_0, COLOR_OPTION_1}},
            {"MyClass.foo:void;$ClassAuthor$reviewers$17",
             std::vector<AnnotationValueType> {std::string("Bob"), std::string("Jim"), std::string("Tom")}},
            {"MyClass.foo:void;$ClassAuthor$reviewersAge$18",
             std::vector<AnnotationValueType> {AGE_18, AGE_21, AGE_32}},
            {"MyClass.foo:void;$ClassAuthor$testBools$19", std::vector<AnnotationValueType> {false, true, false}},
            {"MyClass.foo:void;$ClassAuthor$mutiArray$20",
             std::vector<AnnotationValueType> {VALUE_1, VALUE_2, VALUE_3}},
            {"MyClass.foo:void;$ClassAuthor$mutiArray$21",
             std::vector<AnnotationValueType> {VALUE_4, VALUE_5, VALUE_6}},
            {"MyClass.foo:void;$ClassAuthor$mutiArray$22",
             std::vector<AnnotationValueType> {VALUE_7, VALUE_8, VALUE_9}},
            {"MyClass.foo:void;$ClassAuthor$mutiArray$23",
             std::vector<AnnotationValueType> {std::string("MyClass.foo:void;$ClassAuthor$mutiArray$20"),
                                               std::string("MyClass.foo:void;$ClassAuthor$mutiArray$21"),
                                               std::string("MyClass.foo:void;$ClassAuthor$mutiArray$22")}},
        };
