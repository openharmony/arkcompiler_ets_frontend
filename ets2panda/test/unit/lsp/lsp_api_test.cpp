...
TEST_F(LSPAPITests, GetReferenceLocationAtPosition1)
{
    using ark::es2panda::public_lib::Context;
...
TEST_F(LSPAPITests, GetReferenceLocationAtPosition2)
{
    using ark::es2panda::public_lib::Context;
...
TEST_F(LSPAPITests, GetReferenceLocationAtPosition3)
{
    using ark::es2panda::public_lib::Context;
    std::vector<std::string> fileNames = {"firstFile.sts", "secondFile.sts", "thirdFile.sts"};
    std::vector<std::string> fileContents = {
...
TEST_F(LSPAPITests, GetReferenceLocationAtPosition4)
{
    using ark::es2panda::public_lib::Context;
    std::vector<std::string> fileNames = {"firstFile.sts", "secondFile.sts", "thirdFile.sts"};
    std::vector<std::string> fileContents = {
