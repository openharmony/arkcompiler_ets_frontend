...
constexpr size_t EXPORT_NAMED_DECL_START_COL = 1;
constexpr size_t EXPORT_SINGLE_NAMED_DECL_START_COL = 8;
constexpr size_t RE_EXPORT_DECL_START_COL = 1;
constexpr size_t IMPORT_DECL_START_COL = 1;
constexpr size_t INNER_INTERFACE_START_COL = 3;
constexpr size_t INTERFACE_OUTSIDE_START_COL = 1;
constexpr size_t CLASS_OUTSIDE_START_COL = 1;
constexpr size_t INNER_CLASS_START_COL = 3;
...
constexpr size_t FUNCTION_DECL_START_COL = 1;
constexpr size_t TPALIAS_START_COL = 1;
constexpr size_t TPALIAS2_START_COL = 1;
