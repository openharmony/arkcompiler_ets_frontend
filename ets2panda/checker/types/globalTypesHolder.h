...
enum class GlobalTypeId : std::size_t {
    ...
    ETS_THROWING_LAMBDA0_CLASS,
    ETS_THROWING_LAMBDA1_CLASS,
    ETS_THROWING_LAMBDA2_CLASS,
    ETS_THROWING_LAMBDA3_CLASS,
    ETS_THROWING_LAMBDA4_CLASS,
    ETS_THROWING_LAMBDA5_CLASS,
    ETS_THROWING_LAMBDA6_CLASS,
    ETS_THROWING_LAMBDA7_CLASS,
    ETS_THROWING_LAMBDA8_CLASS,
    ETS_THROWING_LAMBDA9_CLASS,
    ETS_THROWING_LAMBDA10_CLASS,
    ETS_THROWING_LAMBDA11_CLASS,
    ETS_THROWING_LAMBDA12_CLASS,
    ETS_THROWING_LAMBDA13_CLASS,
    ETS_THROWING_LAMBDA14_CLASS,
    ETS_THROWING_LAMBDA15_CLASS,
    ETS_THROWING_LAMBDA16_CLASS,
    ETS_THROWING_LAMBDAN_CLASS,

    ETS_RETHROWING_LAMBDA0_CLASS,
    ETS_RETHROWING_LAMBDA1_CLASS,
    ETS_RETHROWING_LAMBDA2_CLASS,
    ETS_RETHROWING_LAMBDA3_CLASS,
    ETS_RETHROWING_LAMBDA4_CLASS,
    ETS_RETHROWING_LAMBDA5_CLASS,
    ETS_RETHROWING_LAMBDA6_CLASS,
    ETS_RETHROWING_LAMBDA7_CLASS,
    ETS_RETHROWING_LAMBDA8_CLASS,
    ETS_RETHROWING_LAMBDA9_CLASS,
    ETS_RETHROWING_LAMBDA10_CLASS,
    ETS_RETHROWING_LAMBDA11_CLASS,
    ETS_RETHROWING_LAMBDA12_CLASS,
    ETS_RETHROWING_LAMBDA13_CLASS,
    ETS_RETHROWING_LAMBDA14_CLASS,
    ETS_RETHROWING_LAMBDA15_CLASS,
    ETS_RETHROWING_LAMBDA16_CLASS,
    ETS_RETHROWING_LAMBDAN_CLASS,
...
public:
    ...
    Type *GlobalFunctionBuiltinType(size_t nargs, ThrowMarker flags);
    Type *GlobalLambdaBuiltinType(size_t nargs, ThrowMarker flags);
