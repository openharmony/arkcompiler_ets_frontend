...
public:
    ...
    {
        ES2PANDA_ASSERT(targetType_ != nullptr);
        return targetType_;
    }
    ...
    bool IsUnresolvedRecursive() const
    {
        return isRecursive_ && targetType_ == nullptr;
    }
...
private:
    ...
    Type *GetIdenticalTarget(TypeRelation *relation);
