...
class ETSAwaitedType : public Type {
public:
    ETSAwaitedType() = delete;
    ~ETSAwaitedType() override = default;

    NO_COPY_SEMANTIC(ETSAwaitedType);
    NO_MOVE_SEMANTIC(ETSAwaitedType);

    explicit ETSAwaitedType(ETSTypeParameter *tparam) : Type(TypeFlag::ETS_AWAITED), tparam_(tparam) {}
    ...
    ETSAwaitedType *Instantiate(ArenaAllocator *allocator, TypeRelation *relation,
