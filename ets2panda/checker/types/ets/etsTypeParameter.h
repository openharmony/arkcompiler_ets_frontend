...
public:
    ...
    {
        ES2PANDA_ASSERT(constraint_ != nullptr);
        return constraint_;
    }
    ...
    void SetUnderInference(bool val = true)
    {
        underInference_ = val;
    }

    [[nodiscard]] bool UnderInference() const
    {
        return underInference_;
    }
