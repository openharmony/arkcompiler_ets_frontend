...
[[maybe_unused]] static bool IsSaneETSReferenceType(Type const *type)
{
    static constexpr TypeFlag ETS_SANE_REFERENCE_TYPE =
        ...
        TypeFlag::ETS_TYPE_PARAMETER | TypeFlag::ETS_NONNULLISH | TypeFlag::ETS_REQUIRED_TYPE_PARAMETER |
        TypeFlag::ETS_ANY | TypeFlag::ETS_NEVER | TypeFlag::ETS_UNION | TypeFlag::ETS_ARRAY | TypeFlag::FUNCTION |
        TypeFlag::ETS_PARTIAL_TYPE_PARAMETER | TypeFlag::ETS_TUPLE | TypeFlag::ETS_ENUM | TypeFlag::ETS_READONLY |
...
Type *ETSChecker::GuaranteedTypeForUnionFieldAccess(ir::MemberExpression *memberExpression, ETSUnionType *etsUnionType)
{
    ...
    if (prop->IsIdentifier()) {
        ...
        propertyName = prop->AsStringLiteral()->Str();
    } else {
        return GlobalTypeError();
    }
