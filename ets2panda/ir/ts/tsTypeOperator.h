...
public:
    explicit TSTypeOperator(TypeNode *type, TSOperatorType operatorType, ArenaAllocator *const allocator)
        : TypeNode(AstNodeType::TS_TYPE_OPERATOR, allocator), type_(type), operatorType_(operatorType)
    {
    }
    ...
    TSTypeOperator *Clone(ArenaAllocator *allocator, AstNode *parent) override;
