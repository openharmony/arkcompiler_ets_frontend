...
{
    dumper->Add(
        {{"type", "TSTypeQuery"}, {"exprName", exprName_}, {"annotations", AstDumper::Optional(Annotations())}});
}
...
checker::VerifiedType TSTypeQuery::Check([[maybe_unused]] checker::ETSChecker *checker)
{
