...
constexpr RefactorActionView TO_GENERATE_CONSTRUCTOR_ACTION = {"Generate constructor", "Generate constructor",
                                                               "refactor.rewrite.property.generateConstructor"};
