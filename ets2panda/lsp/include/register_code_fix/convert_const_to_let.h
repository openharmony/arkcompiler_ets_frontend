...
#ifndef CONVERT_CONST_TO_LET_H
#define CONVERT_CONST_TO_LET_H
...
class FixConvertConstToLet : public CodeFixRegistration {
public:
...
private:
    void MakeChangeForConvertConstToLet(ChangeTracker &changeTracker, es2panda_Context *context, size_t pos);
    std::vector<FileTextChanges> GetCodeActionsToConvertConstToLet(const CodeFixContext &context);
};
