...
#ifndef FIX_FORBIDDEN_ANY_TYPE_H
#define FIX_FORBIDDEN_ANY_TYPE_H
...
class FixForbiddenAnyType : public CodeFixRegistration {
public:
    FixForbiddenAnyType();
...
private:
    ...
    std::vector<FileTextChanges> GetCodeActionsToFixForbiddenAnyType(const CodeFixContext &context);
};
