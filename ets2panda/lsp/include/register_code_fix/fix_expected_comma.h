...
#ifndef FIX_EXPECTED_COMMA_H
#define FIX_EXPECTED_COMMA_H
...
class FixExpectedComma : public CodeFixRegistration {
public:
    FixExpectedComma();
    ...
    static ir::AstNode *GetNodeAtLocation(es2panda_Context *context, Range range);
    static void MakeChange(ChangeTracker &changeTracker, es2panda_Context *context, Range range,
                           const std::string &possibleFix);
};
}  // namespace ark::es2panda::lsp
#endif  // FIX_EXPECTED_COMMA_H
