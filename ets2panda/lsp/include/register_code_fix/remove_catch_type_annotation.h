...
#ifndef REMOVE_CATCH_TYPE_ANNOTATION_H
#define REMOVE_CATCH_TYPE_ANNOTATION_H
...
class RemoveCatchTypeAnnotation : public CodeFixRegistration {
public:
    RemoveCatchTypeAnnotation();
...
private:
    ...
    std::vector<FileTextChanges> GetCodeActionsToRemoveCatchTypeAnnotation(const CodeFixContext &context);
};
