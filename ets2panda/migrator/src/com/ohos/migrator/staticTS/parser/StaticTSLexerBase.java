 ...
 */
public abstract class StaticTSLexerBase extends Lexer
{
    /**
    ...
    public StaticTSLexerBase(CharStream input) {
        super(input);
    }
    ...
    {
        if (lastToken == null || lastToken.getType() == StaticTSLexer.OpenBrace)
        {
            String text = getText();
