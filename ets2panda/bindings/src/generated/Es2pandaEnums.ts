...
export enum Es2pandaEnum {
  ...
  ENUM_VARIABLE_HAS_SCOPE = 4,
  ENUM_NODE_HAS_TYPE = 5,
  ENUM_IDENTIFIER_HAS_VARIABLE = 6,
  ENUM_REFERENCE_TYPE_ANNOTATION_IS_NULL = 7,
  ENUM_ARITHMETIC_OPERATION_VALID = 8,
  ENUM_SEQUENCE_EXPRESSION_HAS_LAST_TYPE = 9,
  ENUM_CHECK_INFINITE_LOOP = 10,
  ENUM_FOR_LOOP_CORRECTLY_INITIALIZED = 11,
  ENUM_VARIABLE_HAS_ENCLOSING_SCOPE = 12,
  ENUM_MODIFIER_ACCESS_VALID = 13,
  ENUM_VARIABLE_NAME_IDENTIFIER_NAME_SAME = 14,
  ENUM_CHECK_ABSTRACT_METHOD = 15,
  ENUM_GETTER_SETTER_VALIDATION = 16,
  ENUM_CHECK_SCOPE_DECLARATION = 17,
  ENUM_CHECK_CONST_PROPERTIES = 18,
  ENUM_COUNT = 19,
  ENUM_AFTER_SCOPES_INIT_PHASE_FIRST = 0,
  ENUM_AFTER_SCOPES_INIT_PHASE_LAST = 4,
  ENUM_AFTER_CHECKER_PHASE_FIRST = 5,
  ENUM_AFTER_CHECKER_PHASE_LAST = 18,
  ENUM_FIRST = 0,
  ENUM_LAST = 18,
  ENUM_INVALID = 19
}
...
export enum Es2pandaTokenType {
  ...
  TOKEN_TYPE_LITERAL_TRUE = 6,
  TOKEN_TYPE_LITERAL_FALSE = 7,
  TOKEN_TYPE_LITERAL_NULL = 8,
  TOKEN_TYPE_PUNCTUATOR_NULLISH_COALESCING = 9,
  TOKEN_TYPE_PUNCTUATOR_LOGICAL_OR = 10,
  TOKEN_TYPE_PUNCTUATOR_LOGICAL_AND = 11,
  TOKEN_TYPE_PUNCTUATOR_BITWISE_OR = 12,
  TOKEN_TYPE_PUNCTUATOR_BITWISE_XOR = 13,
  TOKEN_TYPE_PUNCTUATOR_BITWISE_AND = 14,
  TOKEN_TYPE_PUNCTUATOR_EQUAL = 15,
  TOKEN_TYPE_PUNCTUATOR_NOT_EQUAL = 16,
  TOKEN_TYPE_PUNCTUATOR_STRICT_EQUAL = 17,
  TOKEN_TYPE_PUNCTUATOR_NOT_STRICT_EQUAL = 18,
  TOKEN_TYPE_PUNCTUATOR_LESS_THAN = 19,
  TOKEN_TYPE_PUNCTUATOR_LESS_THAN_EQUAL = 20,
  TOKEN_TYPE_PUNCTUATOR_GREATER_THAN = 21,
  TOKEN_TYPE_PUNCTUATOR_GREATER_THAN_EQUAL = 22,
  TOKEN_TYPE_PUNCTUATOR_LEFT_SHIFT = 23,
  TOKEN_TYPE_PUNCTUATOR_RIGHT_SHIFT = 24,
  TOKEN_TYPE_PUNCTUATOR_UNSIGNED_RIGHT_SHIFT = 25,
  TOKEN_TYPE_PUNCTUATOR_PLUS = 26,
  TOKEN_TYPE_PUNCTUATOR_MINUS = 27,
  TOKEN_TYPE_PUNCTUATOR_MULTIPLY = 28,
  TOKEN_TYPE_PUNCTUATOR_DIVIDE = 29,
  TOKEN_TYPE_PUNCTUATOR_MOD = 30,
  TOKEN_TYPE_KEYW_IN = 31,
  TOKEN_TYPE_KEYW_INSTANCEOF = 32,
  TOKEN_TYPE_PUNCTUATOR_EXPONENTIATION = 33,
  TOKEN_TYPE_PUNCTUATOR_LEFT_PARENTHESIS = 34,
  TOKEN_TYPE_PUNCTUATOR_RIGHT_PARENTHESIS = 35,
  TOKEN_TYPE_PUNCTUATOR_LEFT_BRACE = 36,
  TOKEN_TYPE_PUNCTUATOR_RIGHT_BRACE = 37,
  TOKEN_TYPE_PUNCTUATOR_PERIOD = 38,
  TOKEN_TYPE_PUNCTUATOR_PERIOD_PERIOD_PERIOD = 39,
  TOKEN_TYPE_PUNCTUATOR_PERIOD_QUESTION = 40,
  TOKEN_TYPE_PUNCTUATOR_COMMA = 41,
  TOKEN_TYPE_PUNCTUATOR_COLON = 42,
  TOKEN_TYPE_PUNCTUATOR_SEMI_COLON = 43,
  TOKEN_TYPE_PUNCTUATOR_LEFT_SQUARE_BRACKET = 44,
  TOKEN_TYPE_PUNCTUATOR_RIGHT_SQUARE_BRACKET = 45,
  TOKEN_TYPE_PUNCTUATOR_QUESTION_MARK = 46,
  TOKEN_TYPE_PUNCTUATOR_QUESTION_DOT = 47,
  TOKEN_TYPE_PUNCTUATOR_TILDE = 48,
  TOKEN_TYPE_PUNCTUATOR_EXCLAMATION_MARK = 49,
  TOKEN_TYPE_PUNCTUATOR_PLUS_PLUS = 50,
  TOKEN_TYPE_PUNCTUATOR_MINUS_MINUS = 51,
  TOKEN_TYPE_PUNCTUATOR_SUBSTITUTION = 52,
  TOKEN_TYPE_PUNCTUATOR_UNSIGNED_RIGHT_SHIFT_EQUAL = 53,
  TOKEN_TYPE_PUNCTUATOR_RIGHT_SHIFT_EQUAL = 54,
  TOKEN_TYPE_PUNCTUATOR_LEFT_SHIFT_EQUAL = 55,
  TOKEN_TYPE_PUNCTUATOR_PLUS_EQUAL = 56,
  TOKEN_TYPE_PUNCTUATOR_MINUS_EQUAL = 57,
  TOKEN_TYPE_PUNCTUATOR_MULTIPLY_EQUAL = 58,
  TOKEN_TYPE_PUNCTUATOR_DIVIDE_EQUAL = 59,
  TOKEN_TYPE_PUNCTUATOR_MOD_EQUAL = 60,
  TOKEN_TYPE_PUNCTUATOR_BITWISE_AND_EQUAL = 61,
  TOKEN_TYPE_PUNCTUATOR_BITWISE_OR_EQUAL = 62,
  TOKEN_TYPE_PUNCTUATOR_BITWISE_XOR_EQUAL = 63,
  TOKEN_TYPE_PUNCTUATOR_LOGICAL_AND_EQUAL = 64,
  TOKEN_TYPE_PUNCTUATOR_LOGICAL_OR_EQUAL = 65,
  TOKEN_TYPE_PUNCTUATOR_LOGICAL_NULLISH_EQUAL = 66,
  TOKEN_TYPE_PUNCTUATOR_EXPONENTIATION_EQUAL = 67,
  TOKEN_TYPE_PUNCTUATOR_ARROW = 68,
  TOKEN_TYPE_PUNCTUATOR_BACK_TICK = 69,
  TOKEN_TYPE_PUNCTUATOR_HASH_MARK = 70,
  TOKEN_TYPE_PUNCTUATOR_AT = 71,
  TOKEN_TYPE_PUNCTUATOR_FORMAT = 72,
  TOKEN_TYPE_PUNCTUATOR_DOLLAR_DOLLAR = 73,
  TOKEN_TYPE_KEYW_GET = 74,
  TOKEN_TYPE_KEYW_SET = 75,
  TOKEN_TYPE_KEYW_OF = 76,
  TOKEN_TYPE_KEYW_FROM = 77,
  TOKEN_TYPE_KEYW_AS = 78,
  TOKEN_TYPE_KEYW_META = 79,
  TOKEN_TYPE_KEYW_REQUIRE = 80,
  TOKEN_TYPE_KEYW_ABSTRACT = 81,
  TOKEN_TYPE_KEYW_TARGET = 82,
  TOKEN_TYPE_KEYW_OUT = 83,
  TOKEN_TYPE_FIRST_KEYW = 84,
  TOKEN_TYPE_KEYW_AWAIT = 85,
  TOKEN_TYPE_KEYW_BIGINT = 86,
  TOKEN_TYPE_KEYW_BOOLEAN = 87,
  TOKEN_TYPE_KEYW_BYTE = 88,
  TOKEN_TYPE_KEYW_BREAK = 89,
  TOKEN_TYPE_KEYW_CASE = 90,
  TOKEN_TYPE_KEYW_CATCH = 91,
  TOKEN_TYPE_KEYW_CHAR = 92,
  TOKEN_TYPE_KEYW_CLASS = 93,
  TOKEN_TYPE_KEYW_CONST = 94,
  TOKEN_TYPE_KEYW_CONSTRUCTOR = 95,
  TOKEN_TYPE_KEYW_CONTINUE = 96,
  TOKEN_TYPE_KEYW_DEBUGGER = 97,
  TOKEN_TYPE_KEYW_DEFAULT = 98,
  TOKEN_TYPE_KEYW_DELETE = 99,
  TOKEN_TYPE_KEYW_DO = 100,
  TOKEN_TYPE_KEYW_DOUBLE = 101,
  TOKEN_TYPE_KEYW_ELSE = 102,
  TOKEN_TYPE_KEYW_ENUM = 103,
  TOKEN_TYPE_KEYW_EXPORT = 104,
  TOKEN_TYPE_KEYW_EXTENDS = 105,
  TOKEN_TYPE_KEYW_FINALLY = 106,
  TOKEN_TYPE_KEYW_FLOAT = 107,
  TOKEN_TYPE_KEYW_FOR = 108,
  TOKEN_TYPE_KEYW_FUNCTION = 109,
  TOKEN_TYPE_KEYW_IF = 110,
  TOKEN_TYPE_KEYW_IMPORT = 111,
  TOKEN_TYPE_KEYW_INT = 112,
  TOKEN_TYPE_KEYW_LAUNCH = 113,
  TOKEN_TYPE_KEYW_LONG = 114,
  TOKEN_TYPE_KEYW_NATIVE = 115,
  TOKEN_TYPE_KEYW_NEVER = 116,
  TOKEN_TYPE_KEYW_NEW = 117,
  TOKEN_TYPE_KEYW_NUMBER = 118,
  TOKEN_TYPE_KEYW_OBJECT = 119,
  TOKEN_TYPE_KEYW_FINAL = 120,
  TOKEN_TYPE_KEYW_OVERRIDE = 121,
  TOKEN_TYPE_KEYW_REGEXP = 122,
  TOKEN_TYPE_KEYW_RETHROWS = 123,
  TOKEN_TYPE_KEYW_RETURN = 124,
  TOKEN_TYPE_KEYW_SHORT = 125,
  TOKEN_TYPE_KEYW_STRING = 126,
  TOKEN_TYPE_KEYW_STRUCT = 127,
  TOKEN_TYPE_KEYW_SUPER = 128,
  TOKEN_TYPE_KEYW_SWITCH = 129,
  TOKEN_TYPE_KEYW_THIS = 130,
  TOKEN_TYPE_KEYW_THROW = 131,
  TOKEN_TYPE_KEYW_THROWS = 132,
  TOKEN_TYPE_KEYW_TYPE = 133,
  TOKEN_TYPE_KEYW_TRY = 134,
  TOKEN_TYPE_KEYW_TYPEOF = 135,
  TOKEN_TYPE_KEYW_UNDEFINED = 136,
  TOKEN_TYPE_KEYW_UNKNOWN = 137,
  TOKEN_TYPE_KEYW_VAR = 138,
  TOKEN_TYPE_KEYW_VOID = 139,
  TOKEN_TYPE_KEYW_WHILE = 140,
  TOKEN_TYPE_KEYW_WITH = 141,
  TOKEN_TYPE_KEYW_I8 = 142,
  TOKEN_TYPE_KEYW_I16 = 143,
  TOKEN_TYPE_KEYW_I32 = 144,
  TOKEN_TYPE_KEYW_I64 = 145,
  TOKEN_TYPE_KEYW_ISIZE = 146,
  TOKEN_TYPE_KEYW_U8 = 147,
  TOKEN_TYPE_KEYW_U16 = 148,
  TOKEN_TYPE_KEYW_U32 = 149,
  TOKEN_TYPE_KEYW_U64 = 150,
  TOKEN_TYPE_KEYW_USIZE = 151,
  TOKEN_TYPE_KEYW_F32 = 152,
  TOKEN_TYPE_KEYW_F64 = 153,
  TOKEN_TYPE_KEYW_V128 = 154,
  TOKEN_TYPE_KEYW_FUNCREF = 155,
  TOKEN_TYPE_KEYW_EXTERNREF = 156,
  TOKEN_TYPE_KEYW_ANYREF = 157,
  TOKEN_TYPE_KEYW_EQREF = 158,
  TOKEN_TYPE_KEYW_I31REF = 159,
  TOKEN_TYPE_KEYW_DATAREF = 160,
  TOKEN_TYPE_KEYW_ASYNC = 161,
  TOKEN_TYPE_KEYW_READONLY = 162,
  TOKEN_TYPE_KEYW_KEYOF = 163,
  TOKEN_TYPE_KEYW_MODULE = 164,
  TOKEN_TYPE_KEYW_NAMESPACE = 165,
  TOKEN_TYPE_KEYW_INFER = 166,
  TOKEN_TYPE_KEYW_DECLARE = 167,
  TOKEN_TYPE_KEYW_ARGUMENTS = 168,
  TOKEN_TYPE_KEYW_EVAL = 169,
  TOKEN_TYPE_KEYW_STATIC = 170,
  TOKEN_TYPE_KEYW_GLOBAL = 171,
  TOKEN_TYPE_KEYW_IS = 172,
  TOKEN_TYPE_KEYW_ASSERTS = 173,
  TOKEN_TYPE_KEYW_ASSERT = 174,
  TOKEN_TYPE_KEYW_TRAP = 175,
  TOKEN_TYPE_KEYW_PRIVATE = 176,
  TOKEN_TYPE_KEYW_PROTECTED = 177,
  TOKEN_TYPE_KEYW_PUBLIC = 178,
  TOKEN_TYPE_KEYW_INTERNAL = 179,
  TOKEN_TYPE_KEYW_IMPLEMENTS = 180,
  TOKEN_TYPE_KEYW_INTERFACE = 181,
  TOKEN_TYPE_KEYW_PACKAGE = 182,
  TOKEN_TYPE_KEYW_LET = 183,
  TOKEN_TYPE_KEYW_YIELD = 184,
  TOKEN_TYPE_KEYW_ANY = 84
}
...
export enum Es2pandaGlobalTypeId {
  ...
  GLOBAL_TYPE_ID_ETS_NULL_POINTER_EXCEPTION_BUILTIN = 61,
  GLOBAL_TYPE_ID_ETS_ARRAY_INDEX_OUT_OF_BOUNDS_ERROR_BUILTIN = 62,
  GLOBAL_TYPE_ID_ETS_ARITHMETIC_ERROR_BUILTIN = 63,
  GLOBAL_TYPE_ID_ETS_CLASS_NOT_FOUND_EXCEPTION_BUILTIN = 64,
  GLOBAL_TYPE_ID_ETS_CLASS_CAST_ERROR_BUILTIN = 65,
  GLOBAL_TYPE_ID_ETS_OUT_OF_MEMORY_ERROR_BUILTIN = 66,
  GLOBAL_TYPE_ID_ETS_NO_SUCH_METHOD_ERROR_BUILTIN = 67,
  ...
  GLOBAL_TYPE_ID_ETS_FUNCTION0_CLASS = 92,
  GLOBAL_TYPE_ID_ETS_FUNCTION1_CLASS = 93,
  GLOBAL_TYPE_ID_ETS_FUNCTION2_CLASS = 94,
  GLOBAL_TYPE_ID_ETS_FUNCTION3_CLASS = 95,
  GLOBAL_TYPE_ID_ETS_FUNCTION4_CLASS = 96,
  GLOBAL_TYPE_ID_ETS_FUNCTION5_CLASS = 97,
  GLOBAL_TYPE_ID_ETS_FUNCTION6_CLASS = 98,
  GLOBAL_TYPE_ID_ETS_FUNCTION7_CLASS = 99,
  GLOBAL_TYPE_ID_ETS_FUNCTION8_CLASS = 100,
  GLOBAL_TYPE_ID_ETS_FUNCTION9_CLASS = 101,
  GLOBAL_TYPE_ID_ETS_FUNCTION10_CLASS = 102,
  GLOBAL_TYPE_ID_ETS_FUNCTION11_CLASS = 103,
  GLOBAL_TYPE_ID_ETS_FUNCTION12_CLASS = 104,
  GLOBAL_TYPE_ID_ETS_FUNCTION13_CLASS = 105,
  GLOBAL_TYPE_ID_ETS_FUNCTION14_CLASS = 106,
  GLOBAL_TYPE_ID_ETS_FUNCTION15_CLASS = 107,
  GLOBAL_TYPE_ID_ETS_FUNCTION16_CLASS = 108,
  GLOBAL_TYPE_ID_ETS_FUNCTIONN_CLASS = 109,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION0_CLASS = 110,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION1_CLASS = 111,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION2_CLASS = 112,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION3_CLASS = 113,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION4_CLASS = 114,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION5_CLASS = 115,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION6_CLASS = 116,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION7_CLASS = 117,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION8_CLASS = 118,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION9_CLASS = 119,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION10_CLASS = 120,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION11_CLASS = 121,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION12_CLASS = 122,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION13_CLASS = 123,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION14_CLASS = 124,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION15_CLASS = 125,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTION16_CLASS = 126,
  GLOBAL_TYPE_ID_ETS_THROWING_FUNCTIONN_CLASS = 127,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION0_CLASS = 128,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION1_CLASS = 129,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION2_CLASS = 130,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION3_CLASS = 131,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION4_CLASS = 132,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION5_CLASS = 133,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION6_CLASS = 134,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION7_CLASS = 135,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION8_CLASS = 136,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION9_CLASS = 137,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION10_CLASS = 138,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION11_CLASS = 139,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION12_CLASS = 140,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION13_CLASS = 141,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION14_CLASS = 142,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION15_CLASS = 143,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTION16_CLASS = 144,
  GLOBAL_TYPE_ID_ETS_RETHROWING_FUNCTIONN_CLASS = 145,
  GLOBAL_TYPE_ID_TYPE_ERROR = 146,
  GLOBAL_TYPE_ID_COUNT = 147
}
...
export enum Es2pandaOverrideErrorCode {
  ...
  OVERRIDE_ERROR_CODE_OVERRIDDEN_WEAKER = 3
}
export enum Es2pandaResolvedKind {
  RESOLVED_KIND_PROPERTY = 0,
  RESOLVED_KIND_INSTANCE_EXTENSION_FUNCTION = 1
}
