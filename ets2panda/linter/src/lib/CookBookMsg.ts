...
cookBookTag[41] = '';
cookBookTag[42] = 'Usage of reserved keywords is forbidden in SDK API (sdk-api-keywords-avoid)';
...
cookBookTag[141] = 'Function("return this") is not supported (arkts-no-function-return-this)';
...
cookBookTag[264] =
  'The field types of the subclass and parent class must be the same (arkts-class-same-type-prop-with-super)';
...
cookBookTag[415] = '"enableV2Compatibility" function and "makeV1Observed" function is not supported (arkui-no-enableV2Compatibility-and-makeV1Observed-function)';
