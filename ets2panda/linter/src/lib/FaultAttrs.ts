...
faultsAttrs[FaultID.TupleIndex] = new FaultAttributes(62);
...
faultsAttrs[FaultID.LongNumeric] = new FaultAttributes(78);
faultsAttrs[FaultID.ObjectLiteralKeyType] = new FaultAttributes(75);
faultsAttrs[FaultID.ParameterType] = new FaultAttributes(76);
faultsAttrs[FaultID.TemplateStringType] = new FaultAttributes(77);
...
faultsAttrs[FaultID.EsValueType] = new FaultAttributes(151, ProblemSeverity.WARNING);
faultsAttrs[FaultID.EsValueTypeError] = new FaultAttributes(151);
...
faultsAttrs[FaultID.MakeObservedCannotObserveCustomClass] = new FaultAttributes(262);
...
faultsAttrs[FaultID.NoLocalClass] = new FaultAttributes(277);
...
faultsAttrs[FaultID.WrapBuilderGenericNeedArrowFunc] = new FaultAttributes(362);
...
faultsAttrs[FaultID.EntryHasInvalidParamsWithV2] = new FaultAttributes(394);
faultsAttrs[FaultID.EntryHasInvalidLocalStorageWithV2] = new FaultAttributes(395);
...
faultsAttrs[FaultID.BuiltinNewCtor] = new FaultAttributes(403);
faultsAttrs[FaultID.UninitializedArrayElements] = new FaultAttributes(404, ProblemSeverity.WARNING);
faultsAttrs[FaultID.BuiltinFinalClass] = new FaultAttributes(405);
faultsAttrs[FaultID.BuiltinNarrowTypes] = new FaultAttributes(406);
faultsAttrs[FaultID.BuiltinDisableApi] = new FaultAttributes(407);
...
faultsAttrs[FaultID.SdkUnionTypeAmbiguity] = new FaultAttributes(416);
