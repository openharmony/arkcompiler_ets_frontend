...
export interface StageStart<Context> {
  ...
  requires<const Requirements extends ArtifactList>(
    ...artifacts: Requirements
  ): RequiredStageStart<Context, Requirements>;

  use<const Name extends string, const Inputs extends readonly never[], HookOutput>(
    stableName: Name,
...
export class HookStage<Context, Requirements extends ArtifactList, Outputs extends object> {
  ...
  public use<const Name extends string, const Inputs extends readonly HookOutputName<Outputs>[], HookOutput>(
  ...
  public provides<const Name extends string, Value>(
...
class StageStartBuilder<Context> implements StageStart<Context> {
  ...
  public requires<const Requirements extends ArtifactList>(
    ...artifacts: Requirements
  ): RequiredStageStart<Context, Requirements> {
    assertUniqueNames(
  ...
  public use<const Name extends string, const Inputs extends readonly never[], HookOutput>(
    stableName: Name,
    definition: HookDefinition<Context, readonly [], {}, Inputs, HookOutput>,
  ): HookStage<Context, readonly [], Readonly<Record<Name, Awaited<HookOutput>>>> {
...
class RequiredStageStartBuilder<Context, Requirements extends ArtifactList> implements RequiredStageStart<
  Context,
  Requirements
> {
  public readonly hookNames: readonly string[] = [];
