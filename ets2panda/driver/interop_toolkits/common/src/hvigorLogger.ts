...
export type LoggerGetter = (subsystemCode: string) => ILogger;
...
export function createHvigorLogger(subsystemCode: string, loggerGetter?: LoggerGetter): ILogger {
  if (loggerGetter === undefined) {
    return new ConsoleLogger();
  }
  return loggerGetter(subsystemCode);
}
