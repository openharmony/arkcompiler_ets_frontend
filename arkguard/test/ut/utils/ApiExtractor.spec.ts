...
describe('test for ApiExtractor', function () {
  ...
  describe('test for visitPropertyAndName', function () {
    ...
    it('For ApiType.API, when property names with wrong recordkey tag, it will not be added in whitelist', function () {
    ...
    it('For ApiType.API, when property names with recordkey tag for MethodSignature, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.API, when property names with recordkey tag for PropertySignature, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.API, when property names with recordkey tag for Constructor, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.API, when property names with recordkey tag for PropertyDeclaration, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.API, when property names with recordkey tag for MethodDeclaration, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.API, when property names with recordkey tag for SetAccessor, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.API, when property names with recordkey tag for FunctionDeclaration, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.API, when property names with recordkey tag for VariableStatement, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.API, when property names with recordkey tag for TypeAliasDeclaration, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.COMPONENT, when property names with wrong recordkey tag, it will not be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);

      collectApi(filePath, ApiExtractor.ApiType.COMPONENT);
      assert.strictEqual(ApiExtractor.mPropertySet.has('testForRecordkey1'), false);
      assert.strictEqual(ApiExtractor.mPropertySet.has('testForRecordkey2'), false);
      clearAll();
    });

    it('For ApiType.COMPONENT, when property names with recordkey tag for MethodSignature, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.COMPONENT, when property names with recordkey tag for PropertySignature, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.COMPONENT, when property names with recordkey tag for Constructor, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.COMPONENT, when property names with recordkey tag for PropertyDeclaration, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.COMPONENT, when property names with recordkey tag for MethodDeclaration, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.COMPONENT, when property names with recordkey tag for SetAccessor, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.COMPONENT, when property names with recordkey tag for FunctionDeclaration, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.COMPONENT, when property names with recordkey tag for VariableStatement, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
    ...
    it('For ApiType.COMPONENT, when property names with recordkey tag for TypeAliasDeclaration, it should be added in whitelist', function () {
      let filePath: string = 'test/ut/utils/apiTest_visitPropertyAndName/recordkeyTest.d.ts';
      let config: MergedConfig = new MergedConfig();
      config.options.stripSystemApiArgs = false;
      initScanProjectConfigByMergeConfig(config);
